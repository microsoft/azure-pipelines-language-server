...
- Updated language-server to use latest language service version published in [PR#199](https://github.com/microsoft/azure-pipelines-language-server/pull/198)
