...
import { convertErrorToTelemetryMsg } from '../../../../language-service/src/utils/objects';
import { isRelativePath, relativeToAbsolutePath } from '../../../../language-service/src/utils/paths';
import { checkSchemaURI, JSON_SCHEMASTORE_URL, KUBERNETES_SCHEMA_URL } from '../../../../language-service/src/utils/schemaUrls';
import { LanguageService, LanguageSettings, SchemaPriority } from '../../../../language-service/src/yamlLanguageService';
import { SchemaSelectionRequests } from '../../requestTypes';
import { Settings, SettingsState } from '../../yamlSettings';
import { Telemetry } from '../../../../language-service/src/telemetry';
