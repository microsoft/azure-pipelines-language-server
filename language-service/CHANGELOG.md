#### 0.9.2
- Updated `js-yaml` , `fast-uri` to patched versions and added a `browserslist` override to fix vulnerabilities [PR#198](https://github.com/microsoft/azure-pipelines-language-server/pull/198)
