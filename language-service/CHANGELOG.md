#### 0.9.2
- Updated `js-yaml` , `fast-uri` and added browserslist packages to patched versions to fix vulnerabilities [PR#198](https://github.com/microsoft/azure-pipelines-language-server/pull/198)
